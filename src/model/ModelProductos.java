...
public class ModelProductos {
    ...
    public ModelProductos(String idProducto, String nombre, String descripcion, String cantidad, String cantidad_minima, String cantidad_maxima, String usuario_registra, String usuario_actualiza, String unidad_medida) {
        this.idProducto = idProducto;
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.cantidad = cantidad;
